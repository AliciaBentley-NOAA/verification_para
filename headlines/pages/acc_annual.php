...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Global Model Anomaly Correlation Coefficient (1984–2022)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/global/gfs/ops/annual_long_term/images/annual_all_models_acc_valid00Z_HGT_P500_fday5_G002NHX.png">
        <span><b>Description:</b> An Anomaly Correlation Coefficient (ACC) score of 1.0 during a particular year indicates that <u>the 5-day forecasts made during that year</u> were, on average, highly accurate (i.e., essentially perfect) across the Northern Hemisphere. The closer the GFS (black line) is to an ACC score of 1.0 during a particular year, the more accurate the GFS's <u>5-day forecasts</u> were that year. Colored lines represent other weather models, according to the key. An upward trend in a line from left to right indicates that 5-day forecasts have improved from 1984 to 2022.</span>
<br>
<br>
        <image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/global/gfs/ops/annual_long_term/images/annual_gfs_ecm_acc_valid00Z_HGT_P500_fday5_G002NHX.png">
        <span><b>Description:</b> An Anomaly Correlation Coefficient (ACC) score of 1.0 during a particular year indicates that <u>the 5-day forecasts made during that year</u> were, on average, highly accurate (i.e., essentially perfect) across the Northern Hemisphere. The closer a weather model is to an ACC score of 1.0 during a particular year, the more accurate that weather model's <u>5-day forecasts</u> were that year. An upward trend in a line from left to right indicates that 5-day forecasts have improved from 1984 to 2022.<b> GFS = black line.</b><a style="color:red;"> ECMWF = red line.</a></span>
</div>
