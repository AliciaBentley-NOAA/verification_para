...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GFS Precipitation Scores (2002-2022)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/gfs_precip/annual_gfs_precip_fss_10mm.png">
        <span><b>Description:</b> Annual Mean Fraction Skill Score (FSS) measures the average skill of a model's forecasts during a given year. An annual mean FSS of 1 denotes excellent forecasts during a given year, and an annual mean FSS of 0 denotes very poor forecasts during a given year. FSS values for 24-h, 48-h, and 72-h forecasts are shown in red, green, and blue lines, respectively. An increase in FSS from left to right means that forecasts have improved over time.</span>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/gfs_precip/annual_gfs_precip_fss_25mm.png">
...
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/gfs_precip/annual_gfs_precip_ets_0.25in.png">
        <span><b>Description:</b> Annual Mean Equitable Threat Score (ETS) measures the skill of a model's forecasts relative to chance during a given year. The larger the value of the ETS is during a given year, the better a model's forecasts were relative to chance. ETS values for 24-h, 48-h, and 72-h forecasts are shown in red, green, and blue lines, respectively. An increase in ETS from left to right means that forecasts have improved over time.</span>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/gfs_precip/annual_gfs_precip_ets_1in.png">
        <span><b>Description:</b> Annual Mean Equitable Threat Score (ETS) measures the skill of a model's forecasts relative to chance during a given year. The larger the value of the ETS is during a given year, the better a model's forecasts were relative to chance. ETS values for 24-h, 48-h, and 72-h forecasts are shown in red, green, and blue lines, respectively. An increase in ETS from left to right means that forecasts have improved over time.</span>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/gfs_precip/annual_gfs_precip_ets_2in.png">
        <span><b>Description:</b> Annual Mean Equitable Threat Score (ETS) measures the skill of a model's forecasts relative to chance during a given year. The larger the value of the ETS is during a given year, the better a model's forecasts were relative to chance. ETS values for 24-h, 48-h, and 72-h forecasts are shown in red, green, and blue lines, respectively. An increase in ETS from left to right means that forecasts have improved over time.</span>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/gfs_precip/annual_gfs_precip_ets_3in.png">
        <span><b>Description:</b> Annual Mean Equitable Threat Score (ETS) measures the skill of a model's forecasts relative to chance during a given year. The larger the value of the ETS is during a given year, the better a model's forecasts were relative to chance. ETS values for 24-h, 48-h, and 72-h forecasts are shown in red, green, and blue lines, respectively. An increase in ETS from left to right means that forecasts have improved over time.</span>
</div>
