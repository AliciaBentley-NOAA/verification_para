	...
	<div class="col-md-auto col-overlay-img">
        ...
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="cyclones/">
                  <div class="img__overlay">HWRF<br>HMON<br>HAFS-A<br>HAFS-B</div>
                  <img src="../icons/cyclones.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="cyclones/">Hurricane Models</a></div>
        </div>
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="../ocean_lake/">
                  <div class="img__overlay">RTOFS</div>
                  <img src="../icons/ocean_wave.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="../ocean_lake/">Ocean/Lake Models</a></div>
        </div>
        <div class="col-md-auto col-overlay-img">
                ...
                <div class="img-label"><a class="img-model-icon-lnks" href="../air_quality/">Air Quality Models</a></div>
        </div>
</div>
