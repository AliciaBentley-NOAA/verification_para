...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GFS Useful Forecast Day (1989–2022)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/global/gfs/ops/annual_long_term/images/annual_useful_fcst_days_acc06_gfs_valid00Z_HGT_P500_G002NHX.png">
</div>

<!-- /Footer -->
<div class="page-footer">
        <span><b>Description:</b> An Anomaly Correlation Coefficient (ACC) score of 1.0 indicates that the forecast was highly accurate (i.e., essentially perfect) across the Northern Hemisphere. A model is said to have "useful skill" when the ACC score is greater than or equal to 0.6. This plot shows the average forecast day (i.e., forecast length) when the ACC score falls below 0.6 and the GFS loses useful skill. For example, GFS forecasts had less than 6 days of useful skill in 1989 and had greater than 8 days of useful skill in 2022.</span>
</div>
