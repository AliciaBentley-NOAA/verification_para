...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GFS, GEFS, and NAEFS Anomaly Correlation Coefficient Die-off Plot (2022)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/acc_dieoff/NH_H500_PAC_2022.png">
</div>
